  ...
  return (
    <ResponsiveContainer minWidth={200} minHeight={300}>
      <LineChart data={statistics} margin={{ right: 0 }}>
        <Line yAxisId="left" type="monotone" dataKey="gift" stroke="mediumpurple" strokeWidth="2" />
        <Line yAxisId="right" type="monotone" dataKey="money" stroke="mediumseagreen" strokeWidth="2" />
        <XAxis dataKey="name" unit="월" tick={{ fontSize: 13, fill: "#4a4a4a" }} />
        <YAxis yAxisId="left" orientation="left" unit="개" axisLine={false} tick={{ fontSize: 13, fill: "#4a4a4a" }} />
        <YAxis yAxisId="right" orientation="right" unit="만원" axisLine={false} tick={{ fontSize: 13, fill: "#4a4a4a" }} />
